...
public class LoginController {
    ...
    @ApiOperation(value = "使用邮箱+验证码+身份id，来找到密码")
    public Result forgetUser(String email, String emailCode, String idCard) {
        return loginService.forgetUser(email, emailCode, idCard);
    }

    @GetMapping("/modifyPassword")
    @ApiOperation(value = "使用邮箱+邮箱验证码+身份id+新密码，来修改密码")
    public Result modifyPassword(String email, String emailCode, String idCard, String newPassword) {
        return loginService.modifyPassword(email, emailCode, idCard, newPassword);
    }
